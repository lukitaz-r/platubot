...
export default {
  ...
  desc: 'Muestra el fixture de la Platubi. Uso: !platubi-fixture [fecha]',
  permisos: [],
  ...
  execute: async (client, interaction) => {
    ...
    await sendFixture(client, interaction, liga, fechaNum, 'primera');
  },
...
async function sendFixture(client, context, liga, fechaNum, div) {
    ...
    if (fechaNum) {
        ...
        // Por defecto: la primera fecha que tenga partidos pendientes, o la última si todas están jugadas
